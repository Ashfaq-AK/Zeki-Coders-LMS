    ...
    <div className="text-blue-50 min-h-screen py-10 px-6 md:px-20">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-300 leading-relaxed">
          ZekiCoder LMS is designed to empower aspiring developers by providing
          an intuitive and structured learning environment. With a clear focus
          on simplicity and functionality, we aim to make programming less
          intimidating and more practical for beginners.
        </p>
      </section>
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-300">
          Created by <span className="text-cyan-300 font-bold">Zeki Coder</span>
          , a 20-year-old developer passionate about open learning, clean code,
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-300">
          ...
          leaderboards, and collaborative coding rooms. This LMS is just getting
          started 🚀
        </p>
      </section>
